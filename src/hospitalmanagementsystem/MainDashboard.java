...
public class MainDashboard extends JFrame implements ActionListener {
    ...
    private JPanel createMainPanel() {
        ...
        btnPatient       = createMenuCard("👥",  "Gestion Patients",     "Ajouter, modifier et consulter",       new Color(46, 204, 113));
        btnDoctor        = createMenuCard("👨‍⚕️", "Gestion Médecins",     "Gérer les médecins et spécialités",    new Color(52, 152, 219));
        btnAdmission     = createMenuCard("📋",  "Admissions",           "Créer et gérer les admissions",        new Color(155, 89, 182));
        btnHospitalization = createMenuCard("🛏️","Hospitalisation",      "Gérer les lits et chambres",          new Color(230, 126, 34));
        btnConsultation  = createMenuCard("🩺",  "Consultations",        "Enregistrer les consultations",        new Color(26, 188, 156));
        btnExamen        = createMenuCard("🔬",  "Examens",              "Commander et gérer les tests",         new Color(52, 73, 94));
        btnMedicine      = createMenuCard("💊",  "Pharmacie",            "Gérer les médicaments",                new Color(231, 76, 60));
        btnBilling       = createMenuCard("💰",  "Facturation",          "Factures et paiements",                new Color(241, 196, 15));
        btnReports       = createMenuCard("📊",  "Rapports",             "Statistiques et rapports médicaux",    new Color(149, 165, 166));
        btnSettings      = createMenuCard("⚙️",  "Paramètres",           "Configuration du système",             new Color(127, 140, 141));
        btnLogout        = createMenuCard("🚪",  "Déconnexion",          "Se déconnecter du système",            new Color(192, 57, 43));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btnLogout) {
            ...
            new ConsultationPage();                          // ✅ Connecté DB
        }
